...
class ResolutionWorkOrder extends FilterFunctions {
  ...
  constructor(props) {
    ...
    this.state = {
      value: "",
      userList: [], // Your original user list
      assetList: [],
      maintenanceType: [],
      filteredUserList: [],
      filteredAssetList: [],
  ...
  columns = [
    ...
    },
    {
      ...
      width: 80,
      sorter: (a, b) => {
        const valueA = a.checkListExecutionNumber ?? "";
        const valueB = b.checkListExecutionNumber ?? "";
    ...
    },
    {
      ...
      title: "Asset Name",
      width: 160,
      render: (value) => (value?.assetName ? value?.assetName : "-"),
    },
    {
  ...
  selectAllUsers = (e) => {
    ...
    // console.log("Users", allUserValues);
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <CustomCollapsePanel title="Issue Type">
                    <Form.Item name="maintenanceTypeId" style={style.formItem}>
                      <Select
                        mode="multiple"
                        showSearch
                        loading={this.state.isMaintenanceListLoadig}
                        placeholder="Issue Type"
                        allowClear
                        options={this.state.maintenanceType}
                        filterOption={(input, option) =>
                          option.label
                            .toLowerCase()
                            .includes(input.toLowerCase()) || input === ""
...
export default withRouter(withForm(withAuthorization(ResolutionWorkOrder)));
