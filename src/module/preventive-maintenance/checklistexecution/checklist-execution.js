...
import CheckListExecutionAssigService from "../../../services/preventive-maintenance-services/checklist-execution-assign-service";
import CheckListExecutionService from "../../../services/preventive-maintenance-services/checklist-execution-service";
import ReasonService from "../../../services/preventive-maintenance-services/reasos-update -service";
...
class CheckListExecution extends FilterFunctions {
  ...
  columns = [
    ...
    },
    {
      ...
      title: "Start Date",
      width: 100,
      render: (value) => (value != null ? dateFormat(value) : "-"),
  ...
  //     },
  //     width: 60,
  //     // sorter: (a, b) => a.scheduler.localeCompare(b.scheduler),
  //   },
  ...
  render() {
    // console.log("props", this.state.res);
    let prevStartTime = null;
    let newRowStatus = false;
    // let emptyReasonCount=0;
    const {
      filteredUserList,
      filteredAssetList,
      userSearchValue,
          ...
          >
            ...
            <Form.Item name="UserName" hidden style={{ minWidth: "250px" }}>
              <Select
                ...
                allowClear
                options={this.state.getUserList}
              ></Select>
            </Form.Item>
            <Space>
          ...
          <Row gutter={[8, 12]}>
            {this.state?.rows &&
              this.state?.rows.map((item) => {
                ...
                if (prevStartTime === null || prevStartTime !== curStartTime) {
