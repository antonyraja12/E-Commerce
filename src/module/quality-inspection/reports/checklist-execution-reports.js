...
import ChecklistExecutionReportServices from "../../../services/quality-inspection/checklist-execution-report-service";
...
class ChecklistExecutionReports extends FilterFunctions {
  ...
  checklistExecutionReports = new ChecklistExecutionReportServices();
  ...
  columns = [
    ...
    },
    {
      ...
      align: "left",
      render: (value, record) => {
        const targetLink = `/qi/checklist-execution/update/${value}`;
        return (
          <>
