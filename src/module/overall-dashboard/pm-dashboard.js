              ...
              <Col xs={24} sm={24} md={24} lg={24}>
                <Card>
                  <Row>
                    ...
                    >
                      <SelectOutlined style={{ color: 'white', fontSize: '15px' }} />
                    </div>
                    <div>
                      ...
                      <p style={{ marginBottom: '0' }}>
                        <strong>{ticketStatus.length>0?ticketStatus[0]?.Opened:0}</strong>
                      </p>
                    </div>
                  </div> 
                  ...
                  <div style={{ display: "flex", marginLeft:"40px", alignItems: "center" }}>
                    ...
                    >
                      <UserAddOutlined style={{ color: 'white', fontSize: '15px' }} />
                    </div>
                    <div>
                      <p style={{ marginBottom: '0', fontSize: '12px' }}>
                        Assigned
                      ...
                      <p style={{ marginBottom: '0' }}>
                        <strong>{ticketStatus.length>0?ticketStatus[1]?.Assigned:0}</strong>
                      </p>
                    </div>
                  </div> 
                  <div style={{ display: "flex", marginLeft:"40px", alignItems: "center" }}>
                    ...
                    >
                      <BarsOutlined style={{ color: 'white', fontSize: '15px' }} />
                    </div>
                    <div>
                      <p style={{ marginBottom: '0', fontSize: '12px' }}>
                        Resolved
                      ...
                      <p style={{ marginBottom: '0' }}>
                        <strong>{ticketStatus.length>0?ticketStatus[2]?.Resolved:0}</strong>
                      </p>
                    </div>
                  </div> 
                  <div style={{ display: "flex", marginLeft:"40px", alignItems: "center" }}>
                    ...
                    >
                      <WarningOutlined style={{ color: 'white', fontSize: '15px' }} />
                    </div>
                    <div>
                      <p style={{ marginBottom: '0', fontSize: '12px' }}>
                        Rejected
                      ...
                      <p style={{ marginBottom: '0' }}>
                        <strong>{ticketStatus.length>0?ticketStatus[3]?.Rejected:0}</strong>
                      </p>
                    </div>
                  </div> 
                  <div style={{ display: "flex", marginLeft:"40px", alignItems: "center" }}>
                    ...
                    <div>
                      ...
                      <p style={{ marginBottom: '0' }}>
                        <strong>{ticketStatus.length>0?ticketStatus[4]?.Completed:0}</strong>
                      </p>
                    </div>
                  </div>  */}
