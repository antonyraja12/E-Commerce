...
function ShiftPlanningDetail() {
  ...
  const columns = [
    ...
    //     return record.producedQuantity - value;
    //   },
    // },
    // {
    //   dataIndex: "rejectedQuantity",
    ...
    //   },
    //   sorter: (a, b) =>
    //     new Date(a.actualEndTime).getTime() -
    //     new Date(b.actualEndTime).getTime(),
    // },
    // {
    //   dataIndex: "id",
    //   key: "id",
    ...
    //   render: (value) => {
    //     return (
    //       <Button size="small" type="primary" onClick={() => openPopup(value)}>
    //         Add
    //       </Button>
    //     );
    //   },
...
export default ShiftPlanningDetail;
