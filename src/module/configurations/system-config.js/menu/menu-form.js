...
class MenuForm extends PageForm {
  ...
  render() {
    // console.log("pro", this.props.form.getFieldValue().parentId === null || this.props.form.getFieldValue().parentId === undefined)
    // console.log("pro c", this.props.form.getFieldValue());
    const columns = [
      {
        dataIndex: "sno",
        key: "sno",
