import { Button, Form, Input, TreeSelect, Radio, Spin, Row, Col } from "antd";
...
class LocationForm extends PageForm {
        ...
        >
          <Spin spinning={!!this.state.isLoading}>
            ...
            >
              ...
              <Form.Item label="Under" name="parentId" rules={[]}>
                <TreeSelect
                  showSearch
...
export default withForm(LocationForm);
