...
const downloadPdf = async ({ title, columns, data, assetHash }) => {
  ...
  const tableStyles = {
    ...
    lineWidth: 0.2,
    cellWidth: title === "Resolution Work Order Report" ? 21 : "auto",
  };
