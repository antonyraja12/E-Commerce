...
import AdamChatBot from "../../module/adam/adam-chat-bot";
...
const MainContainerOne = (props) => {
  const location = useLocation();
  const hideHeader = ["/tat/work-station", "/tat/andon"].includes(
    location.pathname
  );
  const addPadding = location.pathname.includes("tat");
...
export default withStompSessionProvider(MainContainerOne);
